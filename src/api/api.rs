...
use crate::core::base::{
    EntryContext, ResourceType, ResourceWrapper, ResultStatus, SentinelEntry, SentinelInput,
...
impl EntryBuilder {
    ...
    pub fn with_args(mut self, args: Vec<Arc<dyn Any>>) -> Self {
        self.args = Some(args);
        self
    }

    pub fn with_attachment(mut self, attachments: HashMap<Arc<dyn Any>, Arc<dyn Any>>) -> Self {
